...
export default function NavigationCard() {
    ...
    return (
        ...
        <div className='sticky top-4 z-10'>
            <div className='border border-solid dark:border-gray-900 p-3 dark:bg-gray-800 rounded-xl'>
                <h2 className='dark:text-gray-400 mb-3'>ALW</h2>
                ...
                <Link to="/friends" className={nonActiveElement}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 dark:stroke-white">
                ...
                <Link to="/chats" className={nonActiveElement}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 dark:stroke-white">
                ...
                <Link to="/notification" className={nonActiveElement}>
                    {notification? 
                    <p className='pl-2 pr-2 bg-red-600 text-white rounded-full'>{notification}</p>
                    :
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 dark:stroke-white">
                        <path stroke-linecap="round" strokeinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0M3.124 7.5A8.969 8.969 0 015.292 3m13.416 0a8.969 8.969 0 012.168 4.5" />
                    </svg>}
                    <div className='hidden md:block dark:text-gray-300'>
                        <p>Notifications</p>    
                    </div>                  
